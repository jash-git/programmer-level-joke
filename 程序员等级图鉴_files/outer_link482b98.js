...
var m,w,I=!b.canJumpOnTap||b.isNonWechat,C=document.getElementById("js_pc_weapp_code"),x=document.getElementById("js_pc_weapp_code_img"),B=document.getElementById("js_pc_weapp_code_des");
I&&(h.on(C,"mouseenter",function(){
clearTimeout(m);
...
},k.isInMiniProgram&&-1===A.indexOf(j)&&k.gtVersion("7.0.5",!0)){
...
document.getElementById("js_minipro_dialog_name").innerText='即将打开"'+S.nickname+'"小程序';
...
},"a"==W),I&&(h.on(L,"mouseenter",function(){
function e(e){
function t(){
if(!m&&w===s){
...
e("biz_common/utils/string/html.js");
var f=e("pages/weapp_tpl.html.js"),w=e("biz_wap/utils/ajax.js"),h=e("biz_common/dom/event.js"),y=e("biz_common/tmpl.js"),v=e("biz_common/dom/class.js"),b=e("appmsg/weapp_common.js"),j=e("common/utils.js"),k=e("biz_wap/utils/mmversion.js"),I=e("biz_common/base64.js"),E=e("appmsg/popup_report.js"),C=null,x=null,B=null,T={},z=[],R=b.appidSnInfo,K=[],A=I.fromBase64(appid_list).split(",");
if(a()){
l(),s();
...
var i=e.container;
if(!i)return!1;
for(var l=i.getElementsByTagName("a")||[],d=0,g=l.length;g>d;++d)!function(i){
var d=l[i],g=d.getAttribute("href");
if(!g)return!1;
var f=0,y=d.innerHTML;
/^[^<>]+$/.test(y)?f=1:/^<img[^>]*>$/.test(y)&&(f=2);
var w=d.getAttribute("data-linktype"),j=d.getAttribute("href");
r.on(d,"tap",function(i){
var r=d.getAttribute("href");
if(!r)return!1;
!!e.changeHref&&!/^https?:\/\/mp\.weixin\.qq\.com\/cgi-bin\//.test(r)&&(r=e.changeHref(r,f)),
i.preventDefault();
var l="";
c[d.getAttribute("data-itemshowtype")]&&(l=c[d.getAttribute("data-itemshowtype")]);
var g=document.getElementById("js_link_dialog_name");
if(g.innerText="即将打开新的页面",u[j]&&u[j].subject_name&&"0"===u[j].item_show_type&&u[j].title?g.innerText='即将打开公众号 "'+u[j].subject_name+'" 的'+c[u[j].item_show_type]+"《"+u[j].title+"》":u[j]&&u[j].subject_name&&u[j].item_show_type>=0&&(g.innerText='即将打开公众号 "'+u[j].subject_name+'" 的'+c[u[j].item_show_type]),
i.stopPropagation(),"undefined"==typeof _[j]&&(j.indexOf("mp.weixin.qq.com/s/")>-1||j.indexOf("mp.weixin.qq.com/s?")>-1)?(new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=110809_6_1&r="+Math.random():"undefined"==typeof _[j]&&((new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=110809_7_1&r="+Math.random()),
_=function(){
return u[j]&&u[j].item_show_type>=0&&r.indexOf("mp.weixin.qq.com")>-1&&(m.isIOS||m.isAndroid)&&!m.isInMiniProgram?1==d.getAttribute("clicked")?!1:(a.invoke("openWebViewUseFastLoad",{
url:r,
item_show_type:u[j].item_show_type,
openType:0,
scene:1
},function(e){
console.log("openWebViewUseFastLoad res: ",e),e&&e.err_msg&&-1==e.err_msg.indexOf("ok")?a.invoke("openUrlWithExtraWebview",{
url:r,
openType:1
},function(e){
d.setAttribute("clicked",0),e&&e.err_msg&&-1==e.err_msg.indexOf("ok")&&(window.location.href=url);
}):(d.setAttribute("clicked",0),(new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=28839_37_1");
}),!1):void(m.isAndroid||m.isIOS?p(r,{
sample:1,
reject:function(){
location.href=r;
}
}):location.href=r);
},("1"===w||o(d)||n(d))&&s.report([2,s.getRedirectType(j),"",img_popup?1:0,window.source,s.getUrlData(j)]),
("1"===w||o(d)||n(d))&&img_popup){
console.log("tap img link");
var y=document.getElementById("js_link_dialog");
y.style.display="block",y._url=j,(o(d)||n(d))&&((new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=110809_8_1&r="+Math.random(),
y._type="OTHER"),document.querySelector("body").addEventListener("touchmove",t,{
passive:!1
});
}else _();
return!1;
},!0),r.on(d,"click",function(e){
("1"===w||"2"===w||o(d)||n(d))&&img_popup&&(e.preventDefault(),e.stopPropagation());
},!0);
}(d);
}
var r=e("biz_common/dom/event.js"),p=e("appmsg/open_url_with_webview.js"),a=e("biz_wap/jsapi/core.js"),m=e("biz_wap/utils/mmversion.js"),s=(e("biz_wap/utils/ajax.js"),
...
if("undefined"!=typeof jumpInfo)for(var l=0;l<jumpInfo.length;l++)u[jumpInfo[l].url]={
title:jumpInfo[l].title,
item_show_type:jumpInfo[l].item_show_type,
subject_name:jumpInfo[l].subject_name,
link_type:jumpInfo[l].link_type
};
var _=function(){};
return r.on(document.getElementById("js_link_dialog_ok"),"tap",function(e){
e.stopPropagation(),e.preventDefault();
var o=document.getElementById("js_link_dialog");
"OTHER"===o._type&&((new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=110809_10_1&r="+Math.random()),
s.report([4,s.getRedirectType(o._url),"",img_popup?1:0,window.source,s.getUrlData(o._url)]),
document.querySelector("body").removeEventListener("touchmove",t),_&&_(),o.style.display="none";
}),r.on(document.getElementById("js_link_dialog_cancel"),"tap",function(e){
e.stopPropagation(),e.preventDefault(),document.querySelector("body").removeEventListener("touchmove",t);
var o=document.getElementById("js_link_dialog");
"OTHER"===o._type&&((new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=110809_9_1&r="+Math.random()),
o.style.display="none",s.report([3,s.getRedirectType(o._url),"",img_popup?1:0,window.source,s.getUrlData(o._url)]);
}),i;
});