...
if(console.log("networkchanged",t),t.networkType&&t.simType&&e.opt.networkControl){
...
if("wifi"===t.networkType)if(e._g.showFlowNotice=!1,e.hasBeginPlay())e.isPause()&&!e.isEnd()&&e._g.isUserPause&&"none"!==e.container.find(".js_video_flow").css("display")?(e.pause4outer(),
